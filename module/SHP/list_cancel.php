...
$temp->setReplace("{content}", $temp->getTemplate("./template/SHP/SHP/lists_cancel.html"));
...
//            . "<td>" . $rows['CpDate'] . "</td>"
            . "<td>$CountHC <a href='?SHP/view_cancel&HeadCode=" . $rows['HeadCode'] . "'><i class='fa fa-search'></i></a></td>"
            . "<td>"
